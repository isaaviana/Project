...
namespace FriendsWithPaws
{
    ...
    sealed partial class App : Application
    {
        ...
        void OnSuggestionsRequested(SearchPane sender, SearchPaneSuggestionsRequestedEventArgs args)
        {
            ...
            string[] breeds ={"australian shepherd","basset hound","beagle","border collie","bulldog","dachshund","dalmatian","doberman",
                               "german shepherd","golden retriever","great dane","irish setter","jack russell","shar pei","springer spaniel",
                               "pug","west highland","yorkshire terrier"};
            List<string> termList = new List<string>(breeds);
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            //This code will allow the user to go to the specific breed details.
            ...
            if (rootFrame == null)
            {
                ...
                //Register a handler for the SuggestionsRequested event from the search pane
                SearchPane.GetForCurrentView().SuggestionsRequested += OnSuggestionsRequested;

                //this code allow naviagting to the breed details page if the app was started from a secondary tile and was not already running.
